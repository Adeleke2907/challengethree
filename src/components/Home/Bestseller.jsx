    ...
    return (
        <>
            <div className='pt-[50px] pb-[50px] pl-[40px] pr-[40px] w-full'>
                ...
                <div className='flex flex-wrap gap-1 pt-[30px] content-center justify-center w-full'>
                ...
                <div className='flex flex-wrap gap-1  pt-[30px] content-center justify-center'>
                    <div className=' border-[3px] border-[#F6F7F8]'>
